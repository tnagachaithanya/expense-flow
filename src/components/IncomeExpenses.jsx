    ...
    return (
        <div className="glass-panel flex-between" style={{ marginBottom: '20px', padding: '20px 40px' }}>
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--income-color)', fontSize: '1.5rem', fontWeight: '600', marginTop: '5px' }}>+${income}</p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--expense-color)', fontSize: '1.5rem', fontWeight: '600', marginTop: '5px' }}>-${expense}</p>
            </div>
        </div>
    )
}
